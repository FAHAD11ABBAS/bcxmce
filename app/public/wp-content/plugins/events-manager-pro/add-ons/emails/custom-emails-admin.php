...
class EM_Custom_Emails_Admin {
    ...
    public static function init(){
		//Custom Event Emails
		if( em_get_option('dbem_custom_emails_events') ){
				...
				if( em_get_option('dbem_custom_emails_events_admins')){
		...
		if( em_get_option('dbem_custom_emails_gateways') ){
	...
	public static function get_default_email_values( $Gateway = false, $multiple_bookings = false ){
		...
		$email_values = array(
			$mb_key.'admin'=> apply_filters('em_custom_emails_admin_default_email_values', array(
				0 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_pending_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_pending_body'),'status'=>0),
				1 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_confirmed_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_confirmed_body'),'status'=>0),
				2 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_rejected_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_rejected_body'),'status'=>0),
				3 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_cancelled_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_cancelled_body'),'status'=>0)
			), $multiple_bookings, 'admin'),
			$mb_key.'user'=> apply_filters('em_custom_emails_admin_default_email_values', array(
				0 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_email_pending_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_email_pending_body'),'status'=>0),
				1 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_email_confirmed_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_email_confirmed_body'),'status'=>0),
				2 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_email_rejected_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_email_rejected_body'),'status'=>0),
				3 => array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_email_cancelled_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_email_cancelled_body'),'status'=>0)
		...
		if( em_get_option('dbem_custom_emails_gateways') ){
    		...
    		foreach( $gateways as $gateway => $Gateway ){
    		    ...
    		    if( $gateway == 'offline' ){
    		    	$gateway_email_defaults[$gateway.'-'.$mb_key.'admin'][5] = array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_pending_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_contact_email_pending_body'),'status'=>0);
    		    	$gateway_email_defaults[$gateway.'-'.$mb_key.'user'][5] = array('subject'=>em_get_option('dbem_'.$mb_opt.'bookings_email_pending_subject'),'message'=>em_get_option('dbem_'.$mb_opt.'bookings_email_pending_body'),'status'=>0);
    		    }
    			//get custom values if applicable
    			$possible_email_values = maybe_unserialize(em_get_option('em_'.$gateway . "_emails"));
	...
	public static function em_gateway_settings_tab_booking_emails( $Gateway ){
		...
		$admin_emails = false;
		if( em_get_option('dbem_custom_emails_gateways_admins') ){
	...
	public static function meta_boxes(){
		if( current_user_can(self::$caps['custom_emails']) ){
			...
			add_meta_box('em-event-custom-emails', __('Custom Automated Emails','em-pro'), array('EM_Custom_Emails_Admin','event_meta_box'), $screens, 'normal','low');
		}
	}

...
class EM_Emails_Admin {
    ...
    public static function init(){
	    ...
	    // add archetype support for reminders
	    add_filter( 'em_archetypes_overrideable_options', [ static::class, 'archetype_options' ] );
    }
	...
	public static function archetype_options( $options ){
		return array_merge( $options, [
				'dbem_cron_emails' => true,
				'dbem_emp_emails_reminder_days' => true,
				'dbem_emp_emails_reminder_ical' => true,
				'dbem_emp_emails_reminder_subject' => true,
				'dbem_emp_emails_reminder_body' => true
		]);
	}
	...
	public static function reminder_options(){
		...
		<div class="inside">
			<table class='form-table'>
				...
				<tbody data-group="email-reminders">
				<?php
				em_options_radio_binary ( sprintf(_x( 'Enable %s?', 'Enable a feature in settings page', 'em-pro' ), __('Event Email Reminders','em-pro')), 'dbem_cron_emails','', '', '.em-email-reminders');
				?>
				</tbody>
				<tbody class="em-email-reminders" data-group="email-reminders">
				<?php
				...
				<tr>
					...
					<td>
						<input class="em-time-input em-time-start" type="text" name="dbem_emp_emails_reminder_time" value="<?php echo em_get_option('dbem_emp_emails_reminder_time','12:00 AM'); ?>" /><br />

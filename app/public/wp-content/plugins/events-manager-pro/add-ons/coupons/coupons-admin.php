		...
		<div class='wrap nosubsub'>
			...
			<form id='coupon-form' method='post' action=''>
				...
				<table class="form-table">
					...
					<tbody class="em-datepicker em-datepicker-until">
						<tr valign="top" class="em-datepicker-until-fields">
							<th scope="row"><?php esc_html_e_emp('Start Date', 'events-manager') ?></th>
							<td>
								<input type="hidden" class="em-date-input em-date-input-start" aria-hidden="true" placeholder="<?php _e ( 'Start Date', 'events-manager'); ?>" aria-label="<?php _e ( 'Start Date', 'events-manager'); ?>">
								<br>
						...
						<tr valign="top" class="em-datepicker-until-fields">
							...
							<td>
								<input type="hidden" class="em-date-input em-date-input-end" aria-hidden="true" placeholder="<?php _e ( 'End Date', 'events-manager'); ?>" aria-label="<?php _e ( 'End Date', 'events-manager'); ?>">
								<br>
								<em><?php _e('Coupons will not be valid after this date.','em-pro'); ?></em>
							</td>
						</tr>
						<tr class="em-datepicker-data inline-inputs hidden">
							<td colspan="2">
								<input type="date" name="coupon_start" value="<?php echo esc_attr(substr($EM_Coupon->coupon_start,0,10)); ?>" aria-label="<?php _e ( 'Start Date', 'events-manager'); ?>">
								<span class="separator"><?php _e('to','events-manager'); ?></span>
								<input type="date" name="coupon_end" value="<?php echo esc_attr(substr($EM_Coupon->coupon_end,0,10)); ?>"  aria-label="<?php _e ( 'End Date', 'events-manager'); ?>">
							</td>
						</tr>
					</tbody>
					<tr valign="top">
